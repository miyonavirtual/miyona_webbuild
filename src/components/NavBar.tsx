        ...
        <>
            <div className="absolute top-0 left-0 right-0 p-8 flex justify-between items-start pointer-events-none z-20">
                ...
                <div className="pointer-events-auto flex gap-3">
                    ...
                    <div className="bg-background/90 dark:bg-zinc-950/90 backdrop-blur-xl border-2 border-primary/10 shadow-sm rounded-full px-5 py-2 flex items-center gap-2 text-primary">
                        <Gem className="h-5 w-5 fill-primary/20" />
                        <span className="font-bold text-[15px]">150</span>
                    </div>
